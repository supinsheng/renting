	...
	<body>
		<div class="weui-msg">
            <div class="weui-msg__text-area">
				<h2 class="weui-msg__title">密码操作</h2>
			</div>
			<div class="weui-msg__icon-area"><p >请在公众号中回复 修改密码+账号 然后发送身份证照片即可，修改成功会给您回复！</p></div>
			...
			<div class="weui-msg__extra-area">
				<div class="weui-footer">
					<p class="weui-footer__links">
						<a href="javascript:void(0);" class="weui-footer__link">平台名称</a>
					</p>
					<p class="weui-footer__text">Copyright © 2askjdaksdo</p>
				</div>
			</div>
		</div>
	</body>
