...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/css/weixin/productlist.css"/>
	</head>
	<body>
		<div class="wrap">
			...
			<div class="list clearfix" onclick="location.href='{{route('weixin_fanxinzhanshi1')}}' ">
				...
				<div class="addr"><span>&#xe654;</span> 三明市建宁县王家排53-55号</div>
			</div>
			<div class="list clearfix">
				<img src="/images/weixin/bg.jpeg"/>
				<div class="name">高家窠A，B栋公房</div>
				<div class="detail"><span>1306.56㎡建筑面积</span> </div>
				<div class="addr"><span>&#xe654;</span> 三明市建宁县高家窠40号，58号</div>
			</div>
			<div class="list clearfix">
				<img src="/images/weixin/bg.jpeg"/>
				<div class="name">危房</div>
				<div class="detail"><span>47㎡建筑面积</span> </div>
				<div class="addr"><span>&#xe654;</span> 三明市建宁县新生街3号</div>
			</div>
			<div class="list clearfix">
				<img src="/images/weixin/bg.jpeg"/>
				<div class="name">危房</div>
				<div class="detail"><span>113.2㎡建筑面积</span> </div>
				<div class="addr"><span>&#xe654;</span> 三明市建宁县溪口花墩桥25号</div>
			</div>
		</div>
	</body>
</html>
