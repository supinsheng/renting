...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：报修管理</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">流水号</th>
        <th align="center" valign="middle" class="borderright">用户账号</th>
        <th align="center" valign="middle" class="borderright">用户实名</th>
        <th align="center" valign="middle" class="borderright">设备名称</th>
        <th align="center" valign="middle" class="borderright">设备名称</th>
        <th align="center" valign="middle" class="borderright">用户住址</th>
        <th align="center" valign="middle" class="borderright">故障描述</th>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">{{ $v->flow_number }}</td>
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><img src="/images/core/user.png" alt="" width="120"></td>
        ...
        @if($v->state=='审核中')
        <a href="{{ route('repair.edit',['id'=>$v->id,'state'=>'yes'] )}}">同意</a>
        <a href="{{ route('repair.edit',['id'=>$v->id,'state'=>'no'] )}}">否决</a>
        @endif
      </td>
      </tr>
      @endforeach
