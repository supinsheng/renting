...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <tr>
        ...
        <th align="center" valign="middle" class="borderright">创建时间</th>
        <th align="center" valign="middle" class="borderright">最后更新时间</th> 
    ...
    @foreach($data as $k=>$v)
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom" title="{{$v->content}}">{{ str_limit($v->content, 50, '···') }}</td>
        ...
        <a href="{{route('delNew',['id'=>$v->id])}}" onclick="return confirm('请确定是否要删除？ ')" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
      @endforeach
    </table></td>
    </tr>
