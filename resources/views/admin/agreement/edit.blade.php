...
<input type="hidden" name="id" value="{{$data->id}}">
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" name="title" class="form-control" id="inputTitle" placeholder="请填入协议的标题" value="{{$data->title}}">
    </div>
  </div>
  <div class="form-group">
    <label for="content" class="col-sm-2 control-label">协议内容</label>
    <div class="col-sm-9">
      <textarea name="description" id="content" cols="30" rows="10" class="form-control" placeholder="请填入协议的内容">{{$data->description}}</textarea>
    </div>
  </div>
