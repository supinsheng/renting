...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：新闻管理&nbsp;&nbsp;>&nbsp;&nbsp;新闻发布</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" action="{{ route('doAddNew') }}">
    {{ csrf_field() }}
    ...
    @if($errors->has('error'))
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <input type="text" name="title" value="" class="text-word" placeholder="请输入规范的新闻标题" style="width:580px;">
        </td>
    </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
            <textarea name="content" id="" cols="80" rows="20" placeholder="请输入规范的新闻内容"></textarea>
        </td>
      </tr>
